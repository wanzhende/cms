<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/home/lion/Web/html/../application/admin/view/index/branch.html";i:1486720157;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <fieldset class="layui-elem-field" style="min-height:400px; border: none; border-top: 1px solid #e2e2e2">
                ...
                <div class="layui-field-box">
                    <div style="">
                        ...
                        <button id="branchEdit" class="layui-btn layui-btn-primary layui-btn-small">编辑部门</button>
                        <button id="branchAdd" class="layui-btn layui-btn-small">添加子部门</button>
                    </div>
                    <hr>
                    <p>
...
<script src="__STATIC__/public/js/branch.js?v=<?php echo time(); ?>"></script></html>