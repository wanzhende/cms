<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/home/lion/Web/html/../application/admin/view/depart/departedit.html";i:1490949598;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form" method="post" action="">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <button id="departDelete" type="button" class="layui-btn layui-btn-danger">删除</button>
                </div>
            </div>    
        </form>
    </div>
</body>
<script src="__STATIC__/<?php echo \think\Request::instance()->module(); ?>/js/departedit.js?v=<?php echo time(); ?>"></script>
</html>