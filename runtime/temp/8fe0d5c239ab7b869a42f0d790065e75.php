<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/home/lion/Web/html/../application/admin/view/index/staffadd.html";i:1490075911;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <form class="layui-form" method="post" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" name="name" title="员工的姓名" placeholder="请输入姓名" value="" required>
                </div>            
            </div>
            <div class="layui-form-item">
...
<script src="__STATIC__/public/js/staffadd.js?v=<?php echo time(); ?>"></script>
</html>