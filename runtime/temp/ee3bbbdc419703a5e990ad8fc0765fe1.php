<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"/home/lion/Web/html/../application/admin/view/staff/edit.html";i:1492317509;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" id="depart_list" title="请选择部门">
                            <ul>
                                <?php if(is_array($staff['depart']) || $staff['depart'] instanceof \think\Collection || $staff['depart'] instanceof \think\Paginator): $i = 0; $__LIST__ = $staff['depart'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <li><i class="layui-icon">&#xe621;</i><cite><?php echo $vo['name']; ?></cite><input type="hidden" name="depart[]" value="<?php echo $vo['id']; ?>" required=""></li>
