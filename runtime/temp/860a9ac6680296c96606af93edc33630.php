<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/home/lion/Web/html/../application/admin/view/staff/index.html";i:1491986107;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <fieldset class="layui-elem-field" style="min-height:420px;">
            ...
            <div class="layui-field-box">
                ...
                <div>
                    ...
                    <button class="layui-btn layui-btn-small" id="staffAdd">添加员工</button>
                </div>
                <hr>
                <p>
...
<script src="__STATIC__/<?php echo \think\Request::instance()->module(); ?>/js/staff.js?v=<?php echo time(); ?>"></script>
</html>